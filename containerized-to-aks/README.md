...
5. [**Execution: Migration Steps for Containerized Apps on AKS**](#5-execution-migration-steps-for-containerized-apps-on-aks)
   - [5.1 Prepare an application for Azure Kubernetes Service (AKS)](#51-prepare-an-application-for-azure-kubernetes-service-aks)
   - [5.2 Create an Azure Container Registry (ACR) and push build images.](#52-create-an-azure-container-registry-acr-and-push-build-images)  
   - [5.3 Create an Azure Kubernetes Service (AKS) cluster.](#53-create-an-azure-kubernetes-service-aks-cluster)
   - [5.4 Deploy an application to Azure Kubernetes Service (AKS)](#54-deploy-an-application-to-azure-kubernetes-service-aks)
   - [5.5 Use Persistent Volume (PV) and Persistent Volume Claim (PVC) in the deployment.](#55-use-persistent-volume-pv-and-persistent-volume-claim-pvc-in-the-deployment)
